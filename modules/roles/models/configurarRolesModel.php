...
class configurarRolesModel extends Model{
    ...
    private function _set(){
        ...
        $this->_rol  = SimpleForm::getParam('CRDCRtxt_rol');
        $this->_opcion  = Aes::de(SimpleForm::getParam('_opcion'));    /*se decifra*/
        $this->_accion  = Aes::de(SimpleForm::getParam('_accion'));    /*se decifra*/
        $this->_activo  = SimpleForm::getParam('CRDCRchk_activo');
        $this->_accionName  = SimpleForm::getParam('_accionName');
