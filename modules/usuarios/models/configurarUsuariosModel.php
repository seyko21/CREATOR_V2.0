...
class configurarUsuariosModel extends Model{
    ...
    private function _set(){
        ...
        $this->_empleado= Aes::de(SimpleForm::getParam(T4.'txt_empleado'));    /*se decifra*/
        $this->_idUsuario= Aes::de(SimpleForm::getParam('_idUsuario'));    /*se decifra*/
        $this->_activo  = SimpleForm::getParam(T4.'chk_activo');
        $this->_roles  = SimpleForm::getParam(T4.'chk_roles');
        $this->_mail  = SimpleForm::getParam(T4.'txt_email');
        $this->_xsearch  = SimpleForm::getParam(T4.'_term');
    ...
    public function deleteUsuario(){
        ...
        $query = "UPDATE mae_usuario SET activo=:estado WHERE id_usuario=:idUsuario";
        $parms = array(
            ':idUsuario' => $this->_key,
            ':estado' => '0'
        );
