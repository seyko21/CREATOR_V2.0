	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input class="form-control"  placeholder="Buscar" type="text">') :
	...
	DataTable.defaults = {
		...
		"fnServerData": function ( sUrl, aoData, fnCallback, oSettings ) {
			oSettings.jqXHR = $.ajax( {
				"url":  sUrl,
				"data": aoData,
                                beforeSend: function(data2){ /*RDCC*/
                                    if (dataHttpR) {
                                        dataHttpR.abort();
                                    }
                                    dataHttpR = data2;
				...
				"error": function (xhr, error, thrown) {
					if ( error == "parsererror" ) {
						oSettings.oApi._fnLog( oSettings, 0, "DataTables advertencia: datos JSON de "+
							"servidor no se ha podido analizar. Esto es causado por un error de formato JSON." );
					}
				}
			} );
		},
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "<div class='alert alert-info'><i class='fa-fw fa fa-info'></i> No hay datos disponibles en la tabla</div>",
