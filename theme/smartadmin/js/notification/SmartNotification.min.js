...
(function($) {
  ...
  $.SmartMessageBox = function(settings, extend) {
    ...
    if (isIE8orlower() == 0) {
      ...
      sound.setAttribute("src", $.sound_path + "voice_alert.mp3");//messagebox.mp3
      //$.get();
